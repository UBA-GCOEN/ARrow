...
namespace Gpm.Common.ThirdParty.MessagePack.Unity
{
    using Internal;
    using Formatters;
    public sealed class Vector2Formatter : IMessagePackFormatter<global::UnityEngine.Vector2>
    {

        public int Serialize(ref byte[] bytes, int offset, global::UnityEngine.Vector2 value, IFormatterResolver formatterResolver)
        {
        ...
        public global::UnityEngine.Vector2 Deserialize(byte[] bytes, int offset, IFormatterResolver formatterResolver, out int readSize)
        {
    ...
    public sealed class Vector3Formatter : IMessagePackFormatter<global::UnityEngine.Vector3>
    {

        public int Serialize(ref byte[] bytes, int offset, global::UnityEngine.Vector3 value, IFormatterResolver formatterResolver)
        {
        ...
        public global::UnityEngine.Vector3 Deserialize(byte[] bytes, int offset, IFormatterResolver formatterResolver, out int readSize)
        {
            if (MessagePackBinary.IsNil(bytes, offset))
            {
                throw new InvalidOperationException("typecode is null, struct not supported");
    ...
    public sealed class Vector4Formatter : IMessagePackFormatter<global::UnityEngine.Vector4>
    {

        public int Serialize(ref byte[] bytes, int offset, global::UnityEngine.Vector4 value, IFormatterResolver formatterResolver)
        {
        ...
        public global::UnityEngine.Vector4 Deserialize(byte[] bytes, int offset, IFormatterResolver formatterResolver, out int readSize)
        {
            if (MessagePackBinary.IsNil(bytes, offset))
            {
                throw new InvalidOperationException("typecode is null, struct not supported");
    ...
    public sealed class QuaternionFormatter : IMessagePackFormatter<global::UnityEngine.Quaternion>
    {

        public int Serialize(ref byte[] bytes, int offset, global::UnityEngine.Quaternion value, IFormatterResolver formatterResolver)
        {
        ...
        public global::UnityEngine.Quaternion Deserialize(byte[] bytes, int offset, IFormatterResolver formatterResolver, out int readSize)
        {
            if (MessagePackBinary.IsNil(bytes, offset))
            {
                throw new InvalidOperationException("typecode is null, struct not supported");
    ...
    public sealed class ColorFormatter : IMessagePackFormatter<global::UnityEngine.Color>
    {

        public int Serialize(ref byte[] bytes, int offset, global::UnityEngine.Color value, IFormatterResolver formatterResolver)
        {
        ...
        public global::UnityEngine.Color Deserialize(byte[] bytes, int offset, IFormatterResolver formatterResolver, out int readSize)
        {
            if (MessagePackBinary.IsNil(bytes, offset))
            {
                throw new InvalidOperationException("typecode is null, struct not supported");
    ...
    public sealed class BoundsFormatter : IMessagePackFormatter<global::UnityEngine.Bounds>
    {

        public int Serialize(ref byte[] bytes, int offset, global::UnityEngine.Bounds value, IFormatterResolver formatterResolver)
        {
        ...
        public global::UnityEngine.Bounds Deserialize(byte[] bytes, int offset, IFormatterResolver formatterResolver, out int readSize)
        {
            if (MessagePackBinary.IsNil(bytes, offset))
            {
                throw new InvalidOperationException("typecode is null, struct not supported");
    ...
    public sealed class RectFormatter : IMessagePackFormatter<global::UnityEngine.Rect>
    {

        public int Serialize(ref byte[] bytes, int offset, global::UnityEngine.Rect value, IFormatterResolver formatterResolver)
        {
        ...
        public global::UnityEngine.Rect Deserialize(byte[] bytes, int offset, IFormatterResolver formatterResolver, out int readSize)
        {
            if (MessagePackBinary.IsNil(bytes, offset))
            {
                throw new InvalidOperationException("typecode is null, struct not supported");
    ...
    public sealed class WrapModeFormatter : IMessagePackFormatter<global::UnityEngine.WrapMode>
    {
        public int Serialize(ref byte[] bytes, int offset, global::UnityEngine.WrapMode value, IFormatterResolver formatterResolver)
        {
            return MessagePackBinary.WriteInt32(ref bytes, offset, (Int32)value);
        }

        public global::UnityEngine.WrapMode Deserialize(byte[] bytes, int offset, IFormatterResolver formatterResolver, out int readSize)
        {
            return (global::UnityEngine.WrapMode)MessagePackBinary.ReadInt32(bytes, offset, out readSize);
        }
    }

    public sealed class GradientModeFormatter : IMessagePackFormatter<global::UnityEngine.GradientMode>
    {
        public int Serialize(ref byte[] bytes, int offset, global::UnityEngine.GradientMode value, IFormatterResolver formatterResolver)
        {
            return MessagePackBinary.WriteInt32(ref bytes, offset, (Int32)value);
        }

        public global::UnityEngine.GradientMode Deserialize(byte[] bytes, int offset, IFormatterResolver formatterResolver, out int readSize)
        {
            return (global::UnityEngine.GradientMode)MessagePackBinary.ReadInt32(bytes, offset, out readSize);
        }
    }

    public sealed class KeyframeFormatter : IMessagePackFormatter<global::UnityEngine.Keyframe>
    {

        public int Serialize(ref byte[] bytes, int offset, global::UnityEngine.Keyframe value, IFormatterResolver formatterResolver)
        {
        ...
        public global::UnityEngine.Keyframe Deserialize(byte[] bytes, int offset, IFormatterResolver formatterResolver, out int readSize)
        {
            if (MessagePackBinary.IsNil(bytes, offset))
            {
                throw new InvalidOperationException("typecode is null, struct not supported");
    ...
    public sealed class AnimationCurveFormatter : IMessagePackFormatter<global::UnityEngine.AnimationCurve>
    {

        public int Serialize(ref byte[] bytes, int offset, global::UnityEngine.AnimationCurve value, IFormatterResolver formatterResolver)
        {
            if (value == null)
            {
        ...
        public global::UnityEngine.AnimationCurve Deserialize(byte[] bytes, int offset, IFormatterResolver formatterResolver, out int readSize)
        {
            if (MessagePackBinary.IsNil(bytes, offset))
            {
                readSize = 1;
    ...
    public sealed class Matrix4x4Formatter : IMessagePackFormatter<global::UnityEngine.Matrix4x4>
    {

        public int Serialize(ref byte[] bytes, int offset, global::UnityEngine.Matrix4x4 value, IFormatterResolver formatterResolver)
        {
        ...
        public global::UnityEngine.Matrix4x4 Deserialize(byte[] bytes, int offset, IFormatterResolver formatterResolver, out int readSize)
        {
            if (MessagePackBinary.IsNil(bytes, offset))
            {
                throw new InvalidOperationException("typecode is null, struct not supported");
    ...
    public sealed class GradientColorKeyFormatter : IMessagePackFormatter<global::UnityEngine.GradientColorKey>
    {

        public int Serialize(ref byte[] bytes, int offset, global::UnityEngine.GradientColorKey value, IFormatterResolver formatterResolver)
        {
        ...
        public global::UnityEngine.GradientColorKey Deserialize(byte[] bytes, int offset, IFormatterResolver formatterResolver, out int readSize)
        {
            if (MessagePackBinary.IsNil(bytes, offset))
            {
                throw new InvalidOperationException("typecode is null, struct not supported");
    ...
    public sealed class GradientAlphaKeyFormatter : IMessagePackFormatter<global::UnityEngine.GradientAlphaKey>
    {

        public int Serialize(ref byte[] bytes, int offset, global::UnityEngine.GradientAlphaKey value, IFormatterResolver formatterResolver)
        {
        ...
        public global::UnityEngine.GradientAlphaKey Deserialize(byte[] bytes, int offset, IFormatterResolver formatterResolver, out int readSize)
        {
            if (MessagePackBinary.IsNil(bytes, offset))
            {
                throw new InvalidOperationException("typecode is null, struct not supported");
    ...
    public sealed class GradientFormatter : IMessagePackFormatter<global::UnityEngine.Gradient>
    {

        public int Serialize(ref byte[] bytes, int offset, global::UnityEngine.Gradient value, IFormatterResolver formatterResolver)
        {
            if (value == null)
            {
                return MessagePackBinary.WriteNil(ref bytes, offset);
        ...
        public global::UnityEngine.Gradient Deserialize(byte[] bytes, int offset, IFormatterResolver formatterResolver, out int readSize)
        {
            if (MessagePackBinary.IsNil(bytes, offset))
            {
                readSize = 1;
    ...
    public sealed class Color32Formatter : IMessagePackFormatter<global::UnityEngine.Color32>
    {

        public int Serialize(ref byte[] bytes, int offset, global::UnityEngine.Color32 value, IFormatterResolver formatterResolver)
        {
        ...
        public global::UnityEngine.Color32 Deserialize(byte[] bytes, int offset, IFormatterResolver formatterResolver, out int readSize)
        {
            if (MessagePackBinary.IsNil(bytes, offset))
            {
                throw new InvalidOperationException("typecode is null, struct not supported");
    ...
    public sealed class RectOffsetFormatter : IMessagePackFormatter<global::UnityEngine.RectOffset>
    {

        public int Serialize(ref byte[] bytes, int offset, global::UnityEngine.RectOffset value, IFormatterResolver formatterResolver)
        {
            if (value == null)
            {
                return MessagePackBinary.WriteNil(ref bytes, offset);
        ...
        public global::UnityEngine.RectOffset Deserialize(byte[] bytes, int offset, IFormatterResolver formatterResolver, out int readSize)
        {
            if (MessagePackBinary.IsNil(bytes, offset))
            {
                readSize = 1;
    ...
    public sealed class LayerMaskFormatter : IMessagePackFormatter<global::UnityEngine.LayerMask>
    {

        public int Serialize(ref byte[] bytes, int offset, global::UnityEngine.LayerMask value, IFormatterResolver formatterResolver)
        {
        ...
        public global::UnityEngine.LayerMask Deserialize(byte[] bytes, int offset, IFormatterResolver formatterResolver, out int readSize)
        {
            if (MessagePackBinary.IsNil(bytes, offset))
            {
                throw new InvalidOperationException("typecode is null, struct not supported");
    ...
    public sealed class Vector2IntFormatter : IMessagePackFormatter<global::UnityEngine.Vector2Int>
    {

        public int Serialize(ref byte[] bytes, int offset, global::UnityEngine.Vector2Int value, IFormatterResolver formatterResolver)
        {
        ...
        public global::UnityEngine.Vector2Int Deserialize(byte[] bytes, int offset, IFormatterResolver formatterResolver, out int readSize)
        {
            if (MessagePackBinary.IsNil(bytes, offset))
            {
                throw new InvalidOperationException("typecode is null, struct not supported");
    ...
    public sealed class Vector3IntFormatter : IMessagePackFormatter<global::UnityEngine.Vector3Int>
    {

        public int Serialize(ref byte[] bytes, int offset, global::UnityEngine.Vector3Int value, IFormatterResolver formatterResolver)
        {
        ...
        public global::UnityEngine.Vector3Int Deserialize(byte[] bytes, int offset, IFormatterResolver formatterResolver, out int readSize)
        {
            if (MessagePackBinary.IsNil(bytes, offset))
            {
                throw new InvalidOperationException("typecode is null, struct not supported");
    ...
    public sealed class RangeIntFormatter : IMessagePackFormatter<global::UnityEngine.RangeInt>
    {

        public int Serialize(ref byte[] bytes, int offset, global::UnityEngine.RangeInt value, IFormatterResolver formatterResolver)
        {
        ...
        public global::UnityEngine.RangeInt Deserialize(byte[] bytes, int offset, IFormatterResolver formatterResolver, out int readSize)
        {
            if (MessagePackBinary.IsNil(bytes, offset))
            {
                throw new InvalidOperationException("typecode is null, struct not supported");
    ...
    public sealed class RectIntFormatter : IMessagePackFormatter<global::UnityEngine.RectInt>
    {

        public int Serialize(ref byte[] bytes, int offset, global::UnityEngine.RectInt value, IFormatterResolver formatterResolver)
        {
        ...
        public global::UnityEngine.RectInt Deserialize(byte[] bytes, int offset, IFormatterResolver formatterResolver, out int readSize)
        {
            if (MessagePackBinary.IsNil(bytes, offset))
            {
                throw new InvalidOperationException("typecode is null, struct not supported");
    ...
    public sealed class BoundsIntFormatter : IMessagePackFormatter<global::UnityEngine.BoundsInt>
    {

        public int Serialize(ref byte[] bytes, int offset, global::UnityEngine.BoundsInt value, IFormatterResolver formatterResolver)
        {
        ...
        public global::UnityEngine.BoundsInt Deserialize(byte[] bytes, int offset, IFormatterResolver formatterResolver, out int readSize)
        {
            if (MessagePackBinary.IsNil(bytes, offset))
            {
                throw new InvalidOperationException("typecode is null, struct not supported");
